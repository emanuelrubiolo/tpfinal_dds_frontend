...
const NewCustomer = () => {
  ...
  const handleNameChange = (e) => {
    ...
    if (isValidName(value)) {
      ...
      setValidationErrors(prev => ({ ...prev, name: 'Solo se permiten letras y espacios.' }));
    }
  };
  ...
  const handleLastNameChange = (e) => {
    ...
    if (isValidName(value)) {
      ...
      setValidationErrors(prev => ({ ...prev, lastName: 'Solo se permiten letras y espacios.' }));
    }
  };
  ...
  const handlePhoneChange = (e) => {
    ...
    if (isValidPhone(value)) {
      ...
      setValidationErrors(prev => ({ ...prev, phone: 'Solo se permiten números.' }));
    }
  };
            ...
            <form onSubmit={handleSubmit}>
              ...
              <Box mb={2}>
                <FormControl fullWidth>
                  <InputLabel style={{ color: '#9e9e9e', fontFamily: 'Montserrat' }}>Localidad</InputLabel>
                  <Select
                    value={locationId}

      ...
      <Toolbar>
        ...
        <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
          ...
          <Box>
            ...
            >
              <StyledMenuItem component={Link} to="/new-location" onClick={closeLocalitiesMenu}>
                Nueva Localidad
              </StyledMenuItem>
              <StyledMenuItem component={Link} to="/locations" onClick={closeLocalitiesMenu}>
                Editar localidades
              </StyledMenuItem>
            </StyledMenu>
          </Box>
          ...
          <Box>
            ...
            >
              <StyledMenuItem component={Link} to="/new-product" onClick={closeProductsMenu}>
                Nuevo Producto
              </StyledMenuItem>
              <StyledMenuItem component={Link} to="/products" onClick={closeProductsMenu}>
                Editar productos
              </StyledMenuItem>
            </StyledMenu>
          </Box>
        ...
        <Box sx={{ display: { xs: 'flex', md: 'none' } }}>
          ...
          <StyledMenu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleClose}>
            <StyledMenuItem component={Link} to="/customers/new" onClick={handleClose}>
              Nuevo Cliente
            </StyledMenuItem>
            <StyledMenuItem component={Link} to="/new-location" onClick={handleClose}>
              Nueva Localidad
            </StyledMenuItem>
            <StyledMenuItem component={Link} to="/locations" onClick={handleClose}>
              Editar localidades
            </StyledMenuItem>
            <StyledMenuItem component={Link} to="/new-product" onClick={handleClose}>
              Nuevo Producto
            </StyledMenuItem>
            <StyledMenuItem component={Link} to="/products" onClick={handleClose}>
            Editar productos
            </StyledMenuItem>
          </StyledMenu>
        </Box>
